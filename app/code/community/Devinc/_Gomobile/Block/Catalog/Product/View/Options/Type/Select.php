 ...
 */
class Devinc_Gomobile_Block_Catalog_Product_View_Options_Type_Select
    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            switch ($_option->getType()) {
                case Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO:
                    ...
                    if (!$_option->getIsRequire()) {
                        $selectHtml .= '<li><input data-mini="true" type="radio" id="options_' . $_option->getId() . '" class="'
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input data-mini="true" type="' . $type . '" class="' . $class . ' ' . $require
