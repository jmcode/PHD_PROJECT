...
class Belvg_Checkoutfields_Block_Shippingmethod extends Mage_Checkout_Block_Onepage_Billing
{
    
    public function getItemsHtml(){  
        
        $form = new Varien_Data_Form();
        $form->setId('design_checkoutfield')
             ->setName('design')
             ->setMethod('POST')
        ...
        foreach ($collection as $_item){    
            ...
            if ($_item->getCheckoutStep() == 2 && $_item->getIsEnabled() == 1){                   
