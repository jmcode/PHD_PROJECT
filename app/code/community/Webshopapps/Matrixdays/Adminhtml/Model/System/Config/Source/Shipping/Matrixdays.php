...
class Webshopapps_Matrixdays_Adminhtml_Model_System_Config_Source_Shipping_Matrixdays
{
    public function toOptionArray()
    {
		
        $tableRate = Mage::getSingleton('matrixdays_shipping/carrier_matrixdays');
        $arr = array();
