...
ALTER TABLE {$this->getTable('sales_flat_quote_address')}  ADD earliest text;
...
ALTER IGNORE TABLE {$this->getTable('sales_flat_quote_shipping_rate')}  ADD earliest varchar(30);
...
ALTER IGNORE TABLE {$this->getTable('sales_flat_order')}  ADD delivery_packdate date NULL;
ALTER IGNORE TABLE {$this->getTable('sales_flat_order')}  ADD dispatch_date date NULL;
ALTER IGNORE TABLE {$this->getTable('sales_flat_order')}  ADD earliest varchar(30);
