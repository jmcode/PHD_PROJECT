...
class Webshopapps_Timegrid_Block_Adminhtml_Timegrid_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if ($count < 4) {
            Mage::getSingleton('adminhtml/session')->addWarning(Mage::helper('timegrid')->__('Please ensure you have 4 Default time slots else calculations may not work correctly.'));
        }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('time_slot_id', array(
            ...
            'index' => 'time_slot_id',
            'type' => 'options',
            'options' => Mage::helper('matrixdays')->getTimeSlotOptions(),
        ));
