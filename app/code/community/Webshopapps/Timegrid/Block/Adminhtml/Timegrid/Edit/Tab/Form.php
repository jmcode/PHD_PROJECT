...
class Webshopapps_Timegrid_Block_Adminhtml_Timegrid_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array('legend' => Mage::helper('catalogrule')->__('WebShopApps Delivery Date Shipping')));
        $dateFormatIso = Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);

        $defaultPrice = Mage::helper('matrixdays')->getDefaultPrice();
        $defaultSlots = Mage::helper('matrixdays')->getDefaultSlots();
        ...
        $fieldset->addField('time_slot_id', 'select', array(
            ...
            'required' => true,
            'name' => 'time_slot_id',
            'values' => Mage::helper('matrixdays')->getTimeSlots(),
            'note' => 'Time slots are configured under Matrixdays shipping methods',
        ));


        $fieldset->addField('1_price', 'text', array(
