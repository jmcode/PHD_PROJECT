...
class Webshopapps_Timegrid_Adminhtml_TimegridController extends Mage_Adminhtml_Controller_Action
{
	...
	protected function _initAction() {
		$this->loadLayout()
			...
			->_addBreadcrumb(Mage::helper('adminhtml')->__('WebShopApps Delivery Date Shipping'), Mage::helper('adminhtml')->__('WebShopApps Dimensional Box Manager'));
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addBreadcrumb(Mage::helper('adminhtml')->__('Delivery Date Manager'), Mage::helper('adminhtml')->__('WebShopApps Delivery Date Shipping'));
