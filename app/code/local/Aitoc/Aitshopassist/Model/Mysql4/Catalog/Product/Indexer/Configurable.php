 ...
 */
class Aitoc_Aitshopassist_Model_Mysql4_Catalog_Product_Indexer_Configurable extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Indexer_Eav_Source
{
    /**
    ...
    {
        $this->_init('aitshopassist/catalog_product_index_configurable', 'entity_id');
    }
    ...
    public function reindexEntities($processIds)
    {
        ...
        $versionHelper = Mage::helper('aitshopassist');
    ...
    {
        if (Mage::helper('aitshopassist')->isNewReindexAllMethod())
        {
