...
class Magestore_Affiliateplus_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    public function preDispatch()
    {
        ...
        if($groupCode != 'Affiliate'){
            Mage::getSingleton('customer/session')->addNotice($this->_getHelper()->__('Your affiliate account has not been approved. Please wait for our approval.'));
