...
$username = 'Willem Sevenster';
$password = '4hzMwbF5Wjkq';
...
$include_db_tables = 'cataloginventory_stock;cataloginventory_stock_item;cataloginventory_stock_status;catalogrule_product;catalogrule_product_price;catalogsearch_fulltext;catalogsearch_result;catalog_category_entity;catalog_category_entity_datetime;catalog_category_entity_decimal;catalog_category_entity_int;catalog_category_entity_text;catalog_category_entity_varchar;catalog_category_product;catalog_category_product_index;catalog_compare_item;catalog_eav_attribute;catalog_product_bundle_option;catalog_product_bundle_option_value;catalog_product_bundle_price_index;catalog_product_bundle_selection;catalog_product_enabled_index;catalog_product_entity;catalog_product_entity_datetime;catalog_product_entity_decimal;catalog_product_entity_gallery;catalog_product_entity_int;catalog_product_entity_media_gallery;catalog_product_entity_media_gallery_value;catalog_product_entity_text;catalog_product_entity_tier_price;catalog_product_entity_varchar;catalog_product_index_eav;catalog_product_index_price;catalog_product_index_tier_price;catalog_product_index_group_price;catalog_product_link;catalog_product_link_attribute;catalog_product_link_attribute_decimal;catalog_product_link_attribute_int;catalog_product_link_attribute_varchar;catalog_product_link_type;catalog_product_option;catalog_product_option_price;catalog_product_option_title;catalog_product_option_type_price;catalog_product_option_type_title;catalog_product_option_type_value;catalog_product_relation;catalog_product_super_attribute;catalog_product_super_attribute_label;catalog_product_super_attribute_pricing;catalog_product_super_link;catalog_product_website;cms_block;core_config_data;core_store;core_store_group;core_translate;core_url_rewrite;core_website;customer_address_entity;customer_address_entity_datetime;customer_address_entity_decimal;customer_address_entity_int;customer_address_entity_text;customer_address_entity_varchar;customer_eav_attribute;customer_entity;customer_entity_datetime;customer_entity_decimal;customer_entity_int;customer_entity_text;customer_entity_varchar;customer_group;directory_country_region;directory_country_region_name;downloadable_link;downloadable_link_price;downloadable_link_title;downloadable_sample;downloadable_sample_title;eav_attribute;eav_attribute_group;eav_attribute_label;eav_attribute_option;eav_attribute_option_value;eav_attribute_set;eav_entity;eav_entity_attribute;eav_entity_datetime;eav_entity_decimal;eav_entity_int;eav_entity_store;eav_entity_type;newsletter_queue;newsletter_queue_link;newsletter_template;product_alert_price;product_alert_stock;rating;rating_entity;rating_option;rating_option_vote;rating_option_vote_aggregated;rating_store;report_event;report_event_types;report_viewed_product_index;review;review_detail;review_entity;review_entity_summary;review_status;review_store;rating_title;salesrule_customer;sales_flat_creditmemo;sales_flat_creditmemo_comment;sales_flat_creditmemo_grid;sales_flat_creditmemo_item;sales_flat_invoice;sales_flat_invoice_comment;sales_flat_invoice_grid;sales_flat_invoice_item;sales_flat_order;sales_flat_order_address;sales_flat_order_grid;sales_flat_order_item;sales_flat_order_payment;sales_flat_order_status_history;sales_flat_quote;sales_flat_quote_address;sales_flat_quote_address_item;sales_flat_quote_item;sales_flat_quote_item_option;sales_flat_quote_payment;sales_flat_quote_shipping_rate;sales_flat_shipment;sales_flat_shipment_comment;sales_flat_shipment_grid;sales_flat_shipment_item;sales_flat_shipment_track;sales_order_status;sales_order_status_label;sales_order_status_state;sales_order_tax;sales_order_tax_item;tag;tag_properties;tag_relation;tag_summary;tax_class;weee_discount;weee_tax;wishlist;wishlist_item;wishlist_item_option';
...
*/
	...
	foreach($connections as $connection) {
		if(intval($connection->active) == 1) {
			...
			define('DB_TABLE_PREFIX', ($connection->table_prefix ? $connection->table_prefix : ''));
			break;		
		}
	}
}
